...
async function loadSession(sessionId) {
    ...
    viewport.innerHTML = '<div class="p-5 text-center text-white">Synchronizing with Nexus Core...</div>';
...
async function handleSend() {
    ...
    try {
        ...
        removeThinking();
        toggleInputState(false);
        appendMessage("Error: Nexus Core timed out.", 'bot', null, false);
    }
}
...
if (SpeechRecognition) {
    ...
    recognition.onstart = () => {
        ...
        userIn.placeholder = "Nexus-AI is listening...";
    };
